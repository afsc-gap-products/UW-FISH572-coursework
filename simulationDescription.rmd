...
Assuming again that the area of each grid cell is 1, under simple random sampling the design-based estimate is the product of the mean of observations and the total area (1 \* the number of grid cells in the domain). We then calculate the variance, standard error and 95% confidence interval.
...
index_db <- theSample |> 
  ...
  dplyr::mutate(se = sqrt(variance/n),
